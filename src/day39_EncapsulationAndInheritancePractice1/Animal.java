...
public class Animal {
    ...
    public void setName(String name) {
        if (name == null || name.isBlank() || name.isBlank()) {
            System.err.println("Name cannot be null/blank/empty");
            System.exit(1);
        }
        this.name = name;
    }
    ...
    public void setBreed(String breed) {
        if (breed == null || breed.isBlank() || breed.isBlank()) {
            System.err.println("Breed cannot be null/blank/empty");
            System.exit(1);
        }
        this.breed = breed;
    }
    ...
    public void setAge(int age) {
        if (age < 0) {
            System.err.println("Age cannot ve negative number");
            System.exit(1);
        }
        this.age = age;
    }
    ...
    public void setColor(String color) {
        if (color == null || color.isBlank() || color.isBlank()) {
            System.err.println("Color cannot be null/blank/empty");
            System.exit(1);
        }
        this.color = color;
    }
